...
enum CaptureSendFeedbackPhase: Equatable {
    case preparing
    case sending
    case sent
    case pending
...
struct CaptureFeedbackView: View {
    var phase: CaptureSendFeedbackPhase
    var imageData: Data?
    var imageCount = 1
    var message: String?
    ...
    var body: some View {
        feedbackContent
            .frame(maxWidth: phase.showsMessagePanel ? .infinity : 330, alignment: .center)
            .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: overlayAlignment)
            .padding(.bottom, phase.showsMessagePanel ? 20 : 0)
            .transition(.opacity.combined(with: .move(edge: .bottom)))
            .onAppear {
                CaptureFeedback.shared.prepare()
            }
    ...
    private var feedbackContent: some View {
        VStack(spacing: phase.showsMessagePanel ? 14 : 16) {
            imagePreview
            statusPanel
        }
    }
    ...
    private var imagePreview: some View {
        if let imageData, let image = UIImage(data: imageData) {
            ...
            .frame(height: phase.showsMessagePanel ? 430 : 460)
    ...
    private var failureStatusPanel: some View {
        VStack(alignment: .leading, spacing: phase.showsMessagePanel ? 8 : 0) {
            ...
            .frame(maxWidth: .infinity, alignment: phase.showsMessagePanel ? .leading : .center)
        ...
        .padding(.horizontal, phase.showsMessagePanel ? 18 : 16)
        .padding(.vertical, phase.showsMessagePanel ? 16 : 13)
    ...
    private var overlayAlignment: Alignment {
        phase.showsMessagePanel ? .bottom : .center
    }
...
private extension CaptureSendFeedbackPhase {
    var showsMessagePanel: Bool {
